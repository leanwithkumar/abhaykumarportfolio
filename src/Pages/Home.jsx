...
function Home() {
    ...
    <>
      <div className="px-4 md:py-10">
        ...
        <div className="flex items-center text-4xl text-white">
          Hi, I'm Abhay <span className="px-5">👋</span>
        </div>
  ...
  <div className="bg-[#1E1E1E] rounded-2xl p-6 md:p-10">
    <div className="flex items-center gap-2 mb-4">
      <img src="icons/newcontacts.svg" alt="Contact Icon" className="w-6 h-6" />
    ...
    <Link to='/contacts'><button className="px-4 py-2 bg-[#525252] text-white rounded-md hover:opacity-75 transition duration-300">
      Contact me
    </button>
    </Link>
  </div>
