...
function About() {
  ...
  return (
    ...
    <div className="px-4 md:py-10">
        ...
        <button onClick={()=>setActivetab("intro")} className="flex-1 text-center rounded-xl text-white mx-1 px-5 py-2  bg-[#A3A3A3] cursor-pointer">
        Intro
        </button>
        <button onClick={()=>setActivetab("resume")} className="flex-1 text-center rounded-xl text-white mx-1 px-5 py-2 bg-[#A3A3A3] cursor-pointer">
        Resume
        </button>
        <button onClick={()=>{setActivetab("careers")}} className="flex-1 text-center rounded-xl text-white mx-1 px-5 py-2 bg-[#A3A3A3] cursor-pointer">
        Careers
        </button>
        <button onClick={()=>setActivetab("education")} className="flex-1 text-center rounded-xl text-white mx-1 px-5 py-2 bg-[#A3A3A3] cursor-pointer">
         Education
        </button>
        </div>
      ...
      <div className='py-4'>
        ...
        I believe that good communication is super important in any job.<br/><br/><br/>
        I'm good at adapting to different situations, working efficiently, and always trying to do my best. My experience has taught me how to solve problems and lead teams, but I'm also happy to work with others to get things done. I'm excited about the chance to work together and make cool stuff!I'm looking forward to the possibility of working with you!
        Best Regards,<br/><br/>
        Abhay Kumar<br/><br/>
      ...
      {activetab === "resume" && 
      <div>
        I will add my resume at the end of this month.<br/><br/>
      </div>}

      {activetab === "careers" && 
      <div>
        Looking for interns will be great to work with.<br/><br/>
      </div>}
      ...
      <div>
        ...
        <img
        src="icons/bitlogo.png" // replace with your image path
...
<div className='py-2'>
   ...
   <div className="flex items-center bg-[#1a1a1a] rounded-2xl p-4 shadow-md">
      ...
      <div className="ml-4 text-white">
        <h2 className="text-lg ">M.G.M Higher Secondary School</h2>
        <div className="text-sm text-gray-300">
          High School
        </div>
