    ...
    <div className='py-10'>
       <div className='pb-5'>
        ...
        <div className="w-20 h-20 md:w-24 md:h-24 ">
              <img src="https://res.cloudinary.com/djv80zjt7/image/upload/v1755996719/WhatsApp_Image_2025-07-26_at_21.10.37_eef1b394_v0rsst.jpg" alt="abhayimage" className="w-full h-full rounded-full object-cover" />
            </div>
